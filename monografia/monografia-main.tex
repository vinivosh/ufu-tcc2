...
\begin{itemize}
  \item \textbf{Tempo de execução média em 10 execuções do addArrayGPUv1: ~28,345 s.}
  \item \textbf{Tempo de execução média em 10 execuções do addArrayGPUv2: ~410 ms.}
  \item \textbf{Tempo de execução média em 10 execuções do addArrayGPUv3: ~44 ms.}
\end{itemize}
