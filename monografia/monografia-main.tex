...
Há duas importações importantes omitidas no código acima. Uma é a da biblioteca \textit{Numpy}, importada com o nome \textit{np}; a outra é a biblioteca \textit{Pandas}, importada com o nome \textit{pd}.
