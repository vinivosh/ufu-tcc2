...
\begin{figure}[h]
  \caption{Demonstração de algoritmos de agrupamento em datasets variados}
  \centering
  \includegraphics[width=0.95\textwidth]{clusteringExamplesScikitLearn.png}
  \label{fig:clusteringExamples}
\end{figure}

Diversos algoritmos de agrupamento existem, como exemplificados na Figura \ref{fig:clusteringExamples}, e todos possuem vantagens e desvantagens quanto à eficiência de seus resultados para diferentes tipos de conjuntos de dados, além de diferentes complexidades computacionais e tempos de execução.
