...
% Créditos par essa config: https://tex.stackexchange.com/a/83883/295210
% ##################
...
A avaliação dos estudos recentes sobre a paralelização de algoritmos de agrupamento, especialmente os que utilizam a plataforma CUDA para implementá-los em GPUs NVIDIA, revela avanços significativos tanto na eficiência quanto na utilidade prática dos processos de agrupamento. Estas melhorias são notáveis em aplicações que variam desde o processamento de imagens até a física de alta energia.
...
\textbf{TODO: Escrever essa seção, com pedaços de código.}

\begin{python}
  def f(x):
    return x ** 2 # Comentário teste com acentos. É isso mesmo. Mamãe. Testando quebra de linha também dentro desse código de coitado...
\end{python}
