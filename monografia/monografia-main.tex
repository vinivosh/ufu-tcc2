...
A inicialização de mais um array é feita na linha 28, dessa vez \textit{\pythoninline{meansByClosestCent}}, de dimensão $n \cdot d$, que irá armazenar, para cada centróide, as médias das coordenadas de todos os datapoints --- dos logarítimos das coordenadas, mais precisamente --- mais próximos dele.
