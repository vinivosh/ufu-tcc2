...
O foco de pesquisa são \qntAlgrtm{} algoritmos de clustering especialmente notórios: o \textit{K-means} \cite{GPU-accelerated-K-Means} e o \textit{Clustering Hierárquico}. Implementações e estudos realizados sobre estes foram analisados, e implementações paralelas em GPU tiveram seu desempenho comparado com as seriais em CPU.
