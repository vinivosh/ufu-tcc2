...
\begin{itemize}
  \item \textbf{Um dos algoritmos mais tradicionais, explicar a história dele;}
  \item \textbf{Explicar brevemente seu funcionamento (talvez com um pseudo-código bem alto nível?);}
...
\textbf{TODO: Escrever uma sub-seção sobre o Hierarchical Clustering, no mesmo estilo da seção do K-Means.}
...
Tendo em vista os supracitados trechos de código mais computacionalmente custosos e com grande potencial para paralelização, foi implementado o \textbf{K-Means versão paralela}, rodando em GPU.
