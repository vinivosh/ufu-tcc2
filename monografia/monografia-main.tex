...
\textbf{TODO: Escrever parágrafos explicando quais linhas são a mais altamente paralelizáveis do K-Means CPU --- as que foram o foco de modificação na implementação do K-Means GPU.}
