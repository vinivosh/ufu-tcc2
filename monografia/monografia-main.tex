...
\textbf{TODO: Inserir um mini sumário explicando a estrutura do trabalho aqui. Cap. 2: foi feito isso, cap. 3: feito aquilo, cap. 4: aquilo outro, etc.}
...
\section{Datasets e Experimentos}
\label{sec:datasets}
