...
Rodando o programa e medindo o tempo de execução da função \textit{add}, é encontrado que o tempo médio entre dez execuções é de cerca de \textbf{304 milissegundos} e o erro máximo é zero.
...
\codeexternal[
  ...
  caption={Implementação vetorial de soma de vetores usando CUDA},
]{code-snippets/addArrayGPUv3.cu}

\textbf{TODO: Explicar o código do addArrayGPUv3. Tempo de execução média em 10 execuções do: ~42 ms.}
