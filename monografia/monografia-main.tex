...
% TODO
% TODO
% TODO: Atualizar com novos resultados:
% ↪ ./addArrayCPU.bin && sleep 3 && ./addArrayGPUv1.bin && sleep 3 && ./addArrayGPUv2.bin && sleep 3 && ./addArrayGPUv3.bin
% Avg exec time: 304 ms
% Max error: 3.8147e-06
% Avg exec time: 27964 ms
% Max error: 3.8147e-06
% Avg exec time: 121 ms
% Max error: 3.8147e-06
% Avg exec time: 42 ms
% Max error: 3.8147e-06
% TODO
...
Rodando o programa e medindo o tempo de execução da função \textit{add}, é encontrado que o tempo médio entre dez execuções é de cerca de \textbf{313 milissegundos} e o erro máximo é zero.
...
\codeexternal[
  ...
  caption={Implementação veteorial ingênua de soma de vetores usando CUDA},
...
Rodando o programa e medindo novamente o tempo de execução como feito no algoritmo serial, o tempo médio de execução é de cerca de \textbf{410 milissegundos}. O erro máximo também é zero.
...
\codeexternal[
  ...
  caption={Implementação veteorial de soma de vetores usando CUDA},
