...
Para exemplificar bem o processo de paralelização de um algoritmo utilizando CUDA, é apresentada aqui uma implementação simples, na linguagem C++, de um programa que soma dois vetores unidimensionais com mais de cem milhões de elementos cada, do tipo ponto flutuante (\textit{float}).
...
Rodando a função \textit{add()} e medindo seu tempo de execução, encontramos que o tempo médio em dez execuções é de 164,4 milisegundos.
