...
Essa operação de rotação pode parecer simples visualmente, mas internamente requer duas multiplicações de matrizes com valores são obtidos através das operações trigonométricas de seno e cosseno. Essas multiplicações de matrizes, exibidas nas equações \ref{eq:rotationX60CW} e \ref{eq:rotationY30CCW}, precisam ser realizadas para cada vértice de todos os polígonos visíveis na cena a ser renderizada pela placa de vídeo.
