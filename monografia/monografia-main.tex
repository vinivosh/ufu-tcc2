...
Há também um requisito para o formato da entrada de dados para essa implementação do k-means. Todas as variáveis devem ter seus valores normalizados.
...
\textbf{TODO: Escrever capítulo sobre os experimentos realizados e conjuntos de dados utilizados nestes.}
