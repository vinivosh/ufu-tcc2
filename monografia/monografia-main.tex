...
Diversos algoritmos de agrupamento existem, como exemplificados na Figura \ref{fig:clusteringExamples} \cite{clusteringExamplesSciKitLearn}, e todos possuem vantagens e desvantagens quanto à eficiência de seus resultados para diferentes tipos de conjuntos de dados, além de diferentes complexidades computacionais e tempos de execução.
